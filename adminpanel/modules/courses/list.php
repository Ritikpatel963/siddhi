            ...
            <?php foreach ($courses as $course): ?>
                <tr>
                    ...
                    <td class="table-actions">
                        <a class="btn btn-sm btn-outline-secondary" href="<?= e(url('modules/subjects/index.php?course_id=' . $course['id'])) ?>">Subjects</a>
                        <a class="btn btn-sm btn-outline-secondary" href="<?= e(url('modules/study-plans/index.php?course_id=' . $course['id'])) ?>">Plan</a>
